...
### v0.6.0 (当前版本)
- 🐛 修复：题库加载后练习记录页闪屏；练习记录长标题溢出；题库浏览页面列表间隔回正
- 👀 视觉：Bloom 主题 WebGL 噪点背景；HeroUI 组件样式重设计；题目卡片显示优化
- 🛠 功能：题库索引更新 + 频次标签；听力 P1/P4 拼写错误抓取并导入词表；词表切换；数据管理增量导入
- 🎉 开发者：新增阿橙；POI 与 Nana 彩蛋🥚
