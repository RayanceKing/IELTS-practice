...
export function listHistoryAll(query?: HistoryQuery, options?: { maxItems?: number }): Promise<{ source: 'tauri'; items: HistoryListItemVm[]; total: number; limit: number; offset: number; nextCursor: string | null }>
